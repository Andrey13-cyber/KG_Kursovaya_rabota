...
TrianglePyramid::TrianglePyramid(Bitmap*bmp, size_t numVer, size_t numFace) : Figure(bmp, numVer, numFace) {
...
void TrianglePyramid::BasisOfFigure() {
	int i;
	int step = 0;
	double a, b, c, d;
	double t;
...
void TrianglePyramid::ClrFigure() {
...
void TrianglePyramid::SetFigure() {
